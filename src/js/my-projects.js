document.addEventListener('DOMContentLoaded', function() {
    ...
    const newPhotosData = [
        ...
        { url: '/src/img/my-project/img_7@x2.jpg', alt:  'CHEGO JEWELRY WEBSITE' },
        { url: '/src/img/my-project/img_8@x2.jpg', alt:  'MIMINO WEBSITE'    },
        { url: '/src/img/my-project/img_9@x2.jpg', alt: 'VYSHYVANKA VIBES LANDING PAGE' },
        { url: '/src/img/my-project/img_10@x2.jpg', alt:  'POWER PULSE WEBSERVICE'     },
    ];
